...
var clamGenerator = {
  ...
  showPhotos_: function (e) {
    var clams = e.target.responseXML.querySelectorAll('photo');
    for (var n = 0; n < 10; n++) {
...
x
    $('.clam_image').click(function(){
      ...
      document.getElementById('clam_sound').play();
      setTimeout(function(){
        $('#clam_text').hide();
      }, 300);
    });
   ...
   * @private
   */
  constructClamURL_: function (photo) {
